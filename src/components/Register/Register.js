  ...
  return (
    <div className="col-md-12">
      <div className="card card-container">
        <img
          src="https://assets.beyond-experience.com/_assetspp/_images/perfil.png"
          alt="profile-img"
        ...
        <Form onSubmit={handleRegister} ref={form}>
          {!successful && (
            <div>
              ...
              <div className="form-group">
                <label htmlFor="apellido" className="label-text">Apellidos</label>
                <Input
                  type="text"
                  className="form-control"
                  name="apellido"
              ...
              <div className="form-group">
                <label htmlFor="dni" className="label-text">DNI</label>
                <Input
                  type="text"
                  className="form-control"
                  name="dni"
              ...
              <div className="form-group">
                <label htmlFor="username" className="label-text">Nombre de Usurario</label>
                <Input
                  type="text"
                  className="form-control"
                  name="username"
